...
const DEMO_TEAMS = [
  {
    ...
    members: [
      {
        name: 'Arjun Sharma',
        email: 'demo.arjun@indianext.test',
      ...
      {
        name: 'Priya Nair',
        email: 'demo.priya@indianext.test',
      ...
      {
        name: 'Rohit Verma',
        email: 'demo.rohit@indianext.test',
      ...
      {
        name: 'Sneha Iyer',
        email: 'demo.sneha@indianext.test',
        role: 'MEMBER' as const,
        gender: 'Female',
        year: '2nd',
        branch: 'Computer Science',
  ...
  },
  {
    ...
    members: [
      {
        name: 'Karan Mehta',
        email: 'demo.karan@indianext.test',
        role: 'LEADER' as const,
        gender: 'Male',
        year: '4th',
        branch: 'Computer Science',
      ...
      {
        name: 'Ananya Singh',
        email: 'demo.ananya@indianext.test',
        role: 'CO_LEADER' as const,
        gender: 'Female',
        year: '4th',
        branch: 'Data Science',
      ...
      {
        name: 'Riya Kulkarni',
        email: 'demo.riya@indianext.test',
        role: 'MEMBER' as const,
        gender: 'Female',
        year: '3rd',
        branch: 'Computer Science',
  ...
  },
  {
    ...
    members: [
      {
        name: 'Vikram Rao',
        email: 'demo.vikram@indianext.test',
        role: 'LEADER' as const,
        gender: 'Male',
        year: '3rd',
        branch: 'Computer Science',
      ...
      {
        name: 'Meera Joshi',
        email: 'demo.meera@indianext.test',
        role: 'CO_LEADER' as const,
        gender: 'Female',
        year: '3rd',
        branch: 'Mathematics',
      ...
      {
        name: 'Aditya Kumar',
        email: 'demo.aditya@indianext.test',
        role: 'MEMBER' as const,
        gender: 'Male',
        year: '2nd',
        branch: 'Computer Science',
      ...
      {
        name: 'Pooja Reddy',
        email: 'demo.pooja@indianext.test',
        role: 'MEMBER' as const,
        gender: 'Female',
        year: '2nd',
        branch: 'Electronics',
